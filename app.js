...
App({
  onLaunch:function(){
    ...
    wx.setStorageSync('mallName', '我的商城')
  ...
  globalData:{
    userInfo:null,
    subDomain: "", // 如果你的域名是： https://api.it120.cc/abcd 那么这里只要填写 abcd
    version: "1.0.0",
    shareProfile: '幸福生活在招手' // 首页转发的时候话术
  }
...
//   globalData:{
//     userInfo:null,
//     subDomain: "abcd", // 如果你的域名是： https://api.it120.cc/abcd 那么这里只要填写 abcd
//     version: "3.1.0",
